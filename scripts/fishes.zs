...
# seagrass on a stick
recipes.removeShaped(<merpig:seagrassonastick>,
	[ [ <minecraft:fishing_rod>, null                  ],
	  [ null,                    <minecraft:tallgrass:1> ] ]
);
recipes.addShaped(
	"CTSeaGrassOnAStick",
	<merpig:seagrassonastick>,
	[ [ <minecraft:fishing_rod>, null                                    ],
	  [ null,                    <coralreef:coral:4>|<coralreef:coral:5> ] ]
);
...
# rename fungi catfish > spiderfish
<advanced-fishing:fish:29>.displayName = "Spiderfish";
...
recipes.removeShaped(<minecraft:nether_wart> * 2, [[<advanced-fishing:fish:29>]]);
recipes.addShapeless(
	"CTSpiderfish2SpiderEye",
...
# hide unused fish
mods.jei.JEI.removeAndHide(<advanced-fishing:fish:38>);
