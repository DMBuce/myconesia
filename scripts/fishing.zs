...
fishes.addItemEntry(<minecraft:fish:0>, 7); # cod        (default weight 60)
fishes.addItemEntry(<minecraft:fish:1>, 6); # salmon     (default weight 25)
fishes.addItemEntry(<minecraft:fish:2>, 3); # clownfish  (default weight 2)
...
fishes.addItemEntry(<advanced-fishing:fish:3>, 2); # frost minnow
fishes.addItemEntry(<advanced-fishing:fish:4>, 2);
fishes.addItemEntry(<advanced-fishing:fish:5>, 3); # golden koi
...
fishes.addItemEntry(<advanced-fishing:fish:14>, 3); # enderclam
...
#fishes.addItemEntry(<advanced-fishing:fish:21>, 2); # sponge eater
#fishes.addItemEntry(<advanced-fishing:fish:22>, 2); # snowy walleye
...
fishes.addItemEntry(<advanced-fishing:fish:34>, 2); # sunfish
#fishes.addItemEntry(<advanced-fishing:fish:35>, 2); # glacier anchovy
fishes.addItemEntry(<advanced-fishing:fish:36>, 4); # catfish
fishes.addItemEntry(<advanced-fishing:fish:37>, 4); # pike
#fishes.addItemEntry(<advanced-fishing:fish:38>, 2); magikarp
...
junk.removeEntry("minecraft:rotten_flesh");
junk.removeEntry("minecraft:string");
junk.addItemEntry(<minecraft:string> * 2, 15);
junk.addItemEntry(<minecraft:planks:0> * 2, 10);
val extrajunk = junktable.addPool("extrajunk", 0, 2, 0, 0);
extrajunk.addItemEntry(<minecraft:string>, 100);
#extrajunk.addItemEntry(<minecraft:planks:0>, 50);
