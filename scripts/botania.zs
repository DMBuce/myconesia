...
#	[ [ prisshard, <ore:petalAny>,  prisshard ],
#	  [ null,      prisblock, null      ],
#	  [ prisblock, prisblock, prisblock ] ]
#);

val brown_mushroom_blocks = [
...
# pure daisy
## cactus > oak log
## t = 50 -> 22 in 80 ~= 1 in 4 don't turn until the cactus grows
## t = 20 -> 6  in 80 ~= 1 in 13
## t = 15 -> 4  in 28 ~= 1 in 7
## t = 10 -> 3  in 80 ~= 1 in 27
## t = 5  -> 3  in 160 ~= 1 in 53
#mods.botania.PureDaisy.addRecipe(<minecraft:cactus>, <minecraft:log2:0>, 20);
## magma > obsidian
#mods.botania.PureDaisy.addRecipe(<minecraft:magma>, <minecraft:obsidian>);

# pure daisy: brown mushroom > oak log
for block in brown_mushroom_blocks {
	mods.botania.PureDaisy.addRecipe(
		block, <minecraft:log:0>
	);
}
# pure daisy: red mushroom > dark oak log
for block in red_mushroom_blocks {
	mods.botania.PureDaisy.addRecipe(
		block, <minecraft:log2:1>
	);
}
...
# add mushrooms to petal oredict
<ore:petalAny>.add(<botania:mushroom:0>);
<ore:petalAny>.add(<botania:mushroom:1>);
<ore:petalAny>.add(<botania:mushroom:2>);
<ore:petalAny>.add(<botania:mushroom:3>);
<ore:petalAny>.add(<botania:mushroom:4>);
<ore:petalAny>.add(<botania:mushroom:5>);
<ore:petalAny>.add(<botania:mushroom:6>);
<ore:petalAny>.add(<botania:mushroom:7>);
<ore:petalAny>.add(<botania:mushroom:8>);
<ore:petalAny>.add(<botania:mushroom:9>);
<ore:petalAny>.add(<botania:mushroom:10>);
<ore:petalAny>.add(<botania:mushroom:11>);
<ore:petalAny>.add(<botania:mushroom:12>);
<ore:petalAny>.add(<botania:mushroom:13>);
<ore:petalAny>.add(<botania:mushroom:14>);
<ore:petalAny>.add(<botania:mushroom:15>);
